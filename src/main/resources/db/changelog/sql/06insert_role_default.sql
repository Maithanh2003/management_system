...
VALUES
(1, 'Admin User', 'admin@example.com', 'adminpassword', 0, CURRENT_DATE, 'system', CURRENT_DATE, 'system', 'default_avatar.png'),
(2, 'Regular User', 'user@example.com', 'userpassword', 0, CURRENT_DATE, 'system', CURRENT_DATE, 'system', 'default_avatar.png');
